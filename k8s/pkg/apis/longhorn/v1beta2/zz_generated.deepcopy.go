...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EngineImageNodeCapabilities) DeepCopyInto(out *EngineImageNodeCapabilities) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EngineImageNodeCapabilities.
func (in *EngineImageNodeCapabilities) DeepCopy() *EngineImageNodeCapabilities {
	if in == nil {
		return nil
	}
	out := new(EngineImageNodeCapabilities)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EngineImageStatus) DeepCopyInto(out *EngineImageStatus) {
	*out = *in
	...
	if in.NodeCapabilities != nil {
		in, out := &in.NodeCapabilities, &out.NodeCapabilities
		*out = make(map[string]EngineImageNodeCapabilities, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
